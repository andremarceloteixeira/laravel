...
@section('title')
{{ trans('navigation.insureds') }} <small>{{ trans('actions.create', ['type' => trans('insureds.singular')]) }}</small>
@stop
...
@endif
{{ Form::model($insured, ['route' => ['insureds.update', $insured->id], 'method' => 'PATCH', 'class' => 'form-horizontal', 'role' => 'form']) }}
