...
<li class="active"><i class="clip-user"></i> {{ trans('actions.create', ['type' => trans('experts.singular')]) }}</li>
@stop

@section('title')
{{ trans('navigation.experts') }} <small>{{ trans('actions.create', ['type' => trans('experts.singular')]) }}</small>
@stop
...
@endif
{{ Form::open(['route' => 'experts.store', 'files' => true, 'class' => 'form-horizontal', 'role' => 'form']) }}
...
<div class="form-group">
    ...
    <div class="col-sm-9">
        {{ Form::date('birthday', Input::old('birthday')) }}
    </div>
</div>
<div class="form-group">
    <label class="col-sm-2 control-label label_blue">
