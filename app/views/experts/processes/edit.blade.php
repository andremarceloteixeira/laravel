...
@section('breadcrumb')
<li><i class="fa fa-tasks"></i> <a href="{{ route('experts.processes.index') }}">{{ trans('navigation.experts.processes') }}</a></li>
<li class="active"><i class="clip-copy-3"></i> {{ trans('actions.update') . ' ' . trans('processes.singular') . ' ' . $process->certificate }} </li>
@stop

@section('title')
{{ trans('navigation.experts.processes') }} <small>{{ trans('actions.update') . ' ' . trans('processes.singular') . ' ' . $process->certificate }} </small>
@stop
...
@endif
{{ Form::model($process, ['route' => ['experts.processes.update', $process->id], 'method' => 'PATCH', 'files' => true, 'class' => 'form-horizontal', 'role' => 'form']) }}
    ...
    <div class="tab-content">
        <div class="tab-pane active" id="panel_tab_info">
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <span class="input-icon input-icon-right">
                        {{ Form::text('certificate', Input::old('certificate'), ['class' => 'form-control', 'disabled' => 'disabled']) }}
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    {{ Form::text('reference', Input::old('reference'), ['class' => 'form-control', 'disabled' => 'disabled']) }}
                </div>
            </div>
            <div class="form-group">
                <label class="col-sm-2 control-label label_blue">
