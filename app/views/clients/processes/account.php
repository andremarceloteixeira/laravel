...
<div class="col-lg-12 text-right">
    <a href="{{ route('clients.edit', ['id' => $client->user_id]) }}" class="btn btn-md btn-green tooltips" data-placement="top" data-original-title="{{ trans('actions.update') }}"><i class="fa fa-edit"></i></a>
