...
return array(
    ...
    |
    */
    "auth" => "Não existe nenhuma conta com essas credenciais",
    "auth_permission" => "Não tem permissão para aceder a esta ârea",
    ...
    "profile_wrong_password" => "A palavra-chave atual não corresponde à enviada",
